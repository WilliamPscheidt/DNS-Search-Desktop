function pegarDNS() {
    ...
    $("#inputdominio").attr('class', 'd-none');
    $("#container-records").attr('class', 'row d-flex justify-content-center');
    $("li").remove();

    var url = document.getElementById('inputdominio').value

    document.title = 'Whois Internacional -> '+url;
...
function pegarDNS2() {
    ...
    var url = document.getElementById('inputdominio2').value
